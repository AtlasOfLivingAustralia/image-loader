...
class CommandArguments {
    ...
    public static statusBatchSize = new CommandArgument(_switch: "-b", name: "statusBatchSize", defaultValue: 1000, description:  "Batch size for status update operations")
    public static uploadBatchSize = new CommandArgument(_switch: "-b", name: "uploadBatchSize", defaultValue: 10, description:  "Batch size for image upload")
